<%-- 
    Document   : redclassView
    Created on : Mar 8, 2013, 1:10:43 AM
    Author     : KSC
--%>
<%
...
<div class="maincontentinner">
    ...
    <ul class="maintabmenu">
        ...
        <li class="current"><a href="redclass.htm">Red Class</a></li>
    </ul><!--maintabmenu-->
    ...
    <div class="content"> 
        ...
        <div class="contenttitle radiusbottom0">
            <h2 class="table"><span>Red Class</span></h2>
        </div><!--contenttitle-->
        ...
        <div class="contenttitle">
            <h2 class="form"><span>Red Class Form</span></h2>
        </div><!--contenttitle-->
        ...
        <spring:nestedPath path="redclass">
