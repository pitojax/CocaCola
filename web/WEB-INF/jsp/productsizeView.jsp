<%-- 
    Document   : productsizeView
    Created on : Mar 8, 2013, 1:27:55 AM
    Author     : KSC
--%>
<%
...
<div class="maincontentinner">
    ...
    <ul class="maintabmenu">
        ...
        <li  class="current"><a href="productsize.htm">Size</a></li>
    ...
    <div class="content"> 
        ...
        <div class="contenttitle radiusbottom0">
            <h2 class="table"><span>Product Size</span></h2>
        </div><!--contenttitle-->
        ...
        <div class="contenttitle">
            <h2 class="form"><span>Product Size Form</span></h2>
        </div><!--contenttitle-->
        ...
        <spring:nestedPath path="productsize">
                ...
                <p>
                    ...
                    <span class="field">
                        ...
                        <spring:bind path="quantity">
                            <input type="text" name="${status.expression}" value="${status.value}" id="quantity" class="longinput" />
                        </spring:bind>
                    </span>
                </p>
                <p>
