<%-- 
    Document   : glassholdingsView
    Created on : Mar 7, 2013, 9:00:24 PM
    Author     : KSC
--%>
<%
...
<div class="maincontentinner">
    ...
    <ul class="maintabmenu">
        ...
        <li class="current"><a href="glassholdings.htm">Glass Holding</a></li>
    ...
    <div class="content"> 
        ...
        <div class="contenttitle radiusbottom0">
            <h2 class="table"><span>Glass Holding</span></h2>
        </div><!--contenttitle-->
        ...
        <div class="contenttitle">
            <h2 class="form"><span>Glass Holding Form</span></h2>
        </div><!--contenttitle-->
        ...
        <spring:nestedPath path="glassholdings">
                ...
                <p>
                    ...
                    <span class="field">
                        ...
                        <spring:bind path="type">
                            <input type="text" name="${status.expression}" value="${status.value}" id="type" class="longinput" />
                        </spring:bind>
                    </span>
                </p>
                <p>
