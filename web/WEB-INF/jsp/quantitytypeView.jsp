<%-- 
    Document   : quantitytypeView
    Created on : Mar 8, 2013, 1:50:01 AM
    Author     : KSC
--%>
<%
...
<div class="maincontentinner">
    ...
    <div class="content"> 
        ...
        <div class="contenttitle radiusbottom0">
            <h2 class="table"><span>Quantity Type</span></h2>
        </div><!--contenttitle-->
        ...
        <div class="contenttitle">
            <h2 class="form"><span>Quantity Type Form</span></h2>
        </div><!--contenttitle-->
        ...
        <spring:nestedPath path="quantitytype">
                ...
                <p>
                    ...
                    <span class="field">
                        ...
                        <spring:bind path="unit">
                            <input type="text" name="${status.expression}" value="${status.value}" id="unit" class="longinput" />
                        </spring:bind>
                    </span>
                </p>
                <p>
