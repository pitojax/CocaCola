<%-- 
    Document   : outletView
    Created on : Feb 28, 2013, 6:10:21 PM
    Author     : Others
--%>
<% 
...
<div class="maincontentinner">
    ...
    <ul class="maintabmenu">
        ...
        <li class="current"><a href="outlet.htm">Outlet</a></li>
    ...
    <div class="content"> 
        ...
        <div class="contenttitle radiusbottom0">
            <h2 class="table"><span>Outlet</span></h2>
        </div><!--contenttitle-->
        ...
        <div class="contenttitle">
            <h2 class="form"><span>Outlet</span></h2>
        </div><!--contenttitle-->
