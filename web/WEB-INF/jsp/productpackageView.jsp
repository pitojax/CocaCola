<%-- 
    Document   : productpackageView
    Created on : Mar 8, 2013, 1:40:29 AM
    Author     : KSC
--%>
<%
...
<div class="maincontentinner">
    ...
    <ul class="maintabmenu">
        ...
        <li  class="current"><a href="productpackage.htm">Package</a></li>
    ...
    <div class="content"> 
        ...
        <div class="contenttitle radiusbottom0">
            <h2 class="table"><span>Product Package</span></h2>
        </div><!--contenttitle-->
        ...
        <div class="contenttitle">
            <h2 class="form"><span>Product Package Form</span></h2>
        </div><!--contenttitle-->
        ...
        <spring:nestedPath path="productpackage">
