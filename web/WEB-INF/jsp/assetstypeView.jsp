<%-- 
    Document   : assetstypeView
    Created on : Feb 23, 2013, 1:24:51 PM
    Author     : KSC
--%>
<%
...
<div class="maincontentinner">
    ...
    <ul class="maintabmenu">
        ...
        <li  class="current"><a href="registerassetstype.htm">Types</a></li>
    ...
    <div class="content"> 
        ...
        <div class="contenttitle radiusbottom0">
            <h2 class="table"><span>Asset Types</span></h2>
        </div><!--contenttitle-->
        ...
        <div class="contenttitle">
            <h2 class="form"><span>Asset Type Form</span></h2>
        </div><!--contenttitle-->
        ...
        <spring:nestedPath path="assetstype">
